"""
Qwen3-8B Reformulator with TSC_BALANCED prompt (best from 1.7B/4B optimization)

Only uses TSC_BALANCED strategy - the best performing prompt from previous experiments.
Model: Qwen3-8B (local path: /home/luwa/Documents/models/Qwen3-8B)
"""
...
def main():
    parser = argparse.ArgumentParser(description="Qwen3-8B TSC_BALANCED Reformulator")
