"""
Phase 3 (Qwen3-1.7B): 与 0.6B 完全相同的提示词，仅替换模型
用于对比模型规模对改写质量的影响
"""
...
def main():
    parser = argparse.ArgumentParser(description="Phase 3 (Qwen3-1.7B): Same prompts as 0.6B, only model changed")
    ...
    parser.add_argument("--output_dir", type=str, default="dataset/FollowIR_test/dual_queries_experiments_p3_1.7B")
    parser.add_argument("--device", type=str, default="cuda")
    parser.add_argument("--variants", type=str, default="TSC_t01",
    ...
    if results_summary:
        print("\n" + "=" * 140)
        print("PHASE 3 (Qwen3-1.7B) EXPERIMENT RESULTS SUMMARY")
        print("=" * 140)
        ...
        summary_path = os.path.join(args.output_dir, f"experiment_summary_p3_1.7B_{args.task_name}.json")
